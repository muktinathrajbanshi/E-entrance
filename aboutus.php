...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="image/muktinath rajbanshi.jpg" alt="muktinath rajbanshi" style="width:94%">
      <div class="container">
        <h2>Muktinath Rajbanshi</h2>
        <p class="title">Developer</p>
        <p>I am frontend and backend developer.</p>
        <p>muktinathrajbanshi786@gmail.com</p>
        <p><button class="button"><a href="tel:+9779824919810">contact</a></button></button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="image/rajan mabo.jpg" alt="rajan mabo" style="width:100%">
      <div class="container">
        <h2>Rajan Mabo</h2>
        <p class="title">Developer</p>
        <p>I am frontend and backend developer.</p>
        <p>rajanmabo@gmail.com</p>
        <p><button class="button"><a href="tel:+9779805220069">contact</a></button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="image/riya shreshtha.jpg" alt="riya shreshtha" style="width:100%">
      <div class="container">
        <h2>Riya Shreshtha</h2>
        <p class="title">Developer</p>
        <p>I am frontend and backend developer.</p>
        <p>riyashreshtha@gmail.com</p>
        <p><button class="button"><a href="tel:+9779865407007">contact</a></button></button></p>
      </div>
    </div>
  </div>
</div>
